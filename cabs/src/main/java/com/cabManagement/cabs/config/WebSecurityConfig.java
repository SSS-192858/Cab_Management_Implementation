    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf(AbstractHttpConfigurer::disable).authorizeHttpRequests((configurer)->{
                    configurer.requestMatchers("/authenticate","/register_student").permitAll()
                            ...
                            .requestMatchers(HttpMethod.GET, "/driver/getDriver/**").hasAnyRole("DRIVER", "ADMIN")
                            ...
                            .requestMatchers(HttpMethod.GET,"/cabs/allcabs").hasAnyRole("CUSTOMER","ADMIN")
                            ...
                            .requestMatchers(HttpMethod.GET,"/cabs/getByDriverID/**").hasAnyRole("ADMIN","DRIVER")
                            ...
                            .requestMatchers(HttpMethod.GET,"/request/cab/**").hasAnyRole("DRIVER","ADMIN")
                            ...
                            .requestMatchers(HttpMethod.DELETE,"/requests/delete/**").hasAnyRole("ADMIN","DRIVER")
