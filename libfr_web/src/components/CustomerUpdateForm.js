...
import { getCurrentUser, updateDriver } from "../services/auth_services";
...
import { getCustomerFromStorage, getDriverFromStorage, setCustomerInStorage, setDriverInStorage} from "../services/localStorageHandler";
